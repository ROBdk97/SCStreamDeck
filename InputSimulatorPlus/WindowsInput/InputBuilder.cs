...
namespace WindowsInput
{
    ...
    internal class InputBuilder : IEnumerable<INPUT>
    {
        ...
        public IEnumerator<INPUT> GetEnumerator() => _inputList.GetEnumerator();
        ...
        /// <returns>This <see cref="InputBuilder" /> instance.</returns>
        public InputBuilder AddCharacters(string characters) => AddCharacters(characters.ToCharArray());
        ...
        {
            INPUT buttonDown = new INPUT { Type = (uint)InputType.Mouse };
        ...
        {
            INPUT buttonUp = new INPUT { Type = (uint)InputType.Mouse };
        ...
        /// <param name="button"></param>
        /// <returns>This <see cref="InputBuilder" /> instance.</returns>
        public InputBuilder AddMouseButtonClick(MouseButton button) => AddMouseButtonDown(button).AddMouseButtonUp(button);
        ...
        /// <param name="xButtonId"></param>
        /// <returns>This <see cref="InputBuilder" /> instance.</returns>
        public InputBuilder AddMouseXButtonClick(int xButtonId) => AddMouseXButtonDown(xButtonId).AddMouseXButtonUp(xButtonId);
        ...
        public InputBuilder AddMouseButtonDoubleClick(MouseButton button) =>
            AddMouseButtonClick(button).AddMouseButtonClick(button);
        ...
        public InputBuilder AddMouseXButtonDoubleClick(int xButtonId) =>
            AddMouseXButtonClick(xButtonId).AddMouseXButtonClick(xButtonId);
        ...
        {
            INPUT scroll = new INPUT { Type = (uint)InputType.Mouse };
